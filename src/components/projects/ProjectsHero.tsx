  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          variants={fadeUp}
          className="text-white/80 text-base md:text-lg max-w-lg mx-auto leading-relaxed"
        >
          Our projects are built on strong standards—combining thoughtful
          design, practical execution, and attention to detail to create
          lasting, high-quality spaces.
        </motion.p>
      </motion.div>
